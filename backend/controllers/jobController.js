...
// --- Gemini AI Setup ---
const genAI = new GoogleGenerativeAI(process.env.GEMINI_API_KEY);
// Use a stable and powerful model version
const model = genAI.getGenerativeModel({ model: "gemini-2.0-flash" });
    ...
    try {
        ...
        const prompt = `
            ...
            Based on this, provide a JSON object with the following structure:
            {
                "name": "<The candidate's full name>",
                "email": "<The candidate's email address>",
                "summary": "<A 3-4 line professional summary of the candidate's entire resume, highlighting their key experiences, top skills, and overall professional profile.>",
                "scoreBreakdown": [
                    {
                        "criteria": "<The exact text of Criteria 1>",
                        "score": <An integer score from 1-10 for this specific criterion>,
